...
export const ContentSwitcher = () => {
    ...
    return (
        <>
            ...
            {selected === 'usecase' && (
                <div className="mt-12 lg:mt-6 grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4">
                    <HeroCard
            ...
            {selected === 'product' && (
                <div className="mt-12 lg:mt-6 grid sm:grid-cols-2 min-[1300px]:grid-cols-3 gap-x-6 gap-y-4">
                    <HeroCard
