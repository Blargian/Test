...
export const HeroCard = ({ filename, title, description, href, links, icon }) => {
    ...
    const darkFilename = filename ? filename.replace('-light.', '-dark.') : null;
...
<div className="relative">
    ...
    <div className="relative z-10 px-4 py-16 lg:py-12 lg:pb-24 max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-3 mx-auto mt-8">
            ...
            <div role="button" className="kapa-ai-trigger flex-none flex cursor-pointer items-center justify-center gap-1.5 pl-3 pr-3.5 h-9 shadow-none bg-gray-950/[0.03] dark:bg-white/[0.03] border border-white/10" style={{ borderRadius: '4px' }}><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" className="size-4 shrink-0 text-gray-700 hover:text-gray-800 dark:text-[#fdff75]"><g fill="currentColor"><path d="M5.658,2.99l-1.263-.421-.421-1.263c-.137-.408-.812-.408-.949,0l-.421,1.263-1.263,.421c-.204,.068-.342,.259-.342,.474s.138,.406,.342,.474l1.263,.421,.421,1.263c.068,.204,.26,.342,.475,.342s.406-.138,.475-.342l.421-1.263,1.263-.421c.204-.068,.342-.259,.342-.474s-.138-.406-.342-.474Z" fill="currentColor" data-stroke="none" stroke="none"></path><polygon points="9.5 2.75 11.412 7.587 16.25 9.5 11.412 11.413 9.5 16.25 7.587 11.413 2.75 9.5 7.587 7.587 9.5 2.75" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></polygon></g></svg><span className="text-sm text-gray-500 dark:text-white/50 whitespace-nowrap">Ask AI</span></div>
        </div>
