...
export const ContentSwitcher = () => {
    ...
    return (
        <>
            ...
            {selected === 'goal' && (
                <div className="mt-12 lg:mt-6 grid md:grid-cols-3 gap-x-6 gap-y-4">
                    <HeroCard
                        title="Get started"
            ...
            {selected === 'usecase' && (
                <div className="mt-12 lg:mt-6 grid min-[480px]:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4">
                    <HeroCard
                        filename="use-cases/rt-analytics-light.svg"
                        darkFilename="use-cases/rt-analytics.svg"
                    ...
                    />
                    <HeroCard
                        filename="use-cases/observability-light.svg"
                        darkFilename="use-cases/observability.svg"
                        title="Observability"
                    ...
                    />
                    <HeroCard
                        filename="use-cases/data-warehousing-light.svg"
                        darkFilename="use-cases/data-warehousing.svg"
                    ...
                    />
                    <HeroCard
                        filename="use-cases/machine-learning-light.svg"
                        darkFilename="use-cases/machine-learning.svg"
            ...
            {selected === 'product' && (
                <div className="mt-12 lg:mt-6 grid md:grid-cols-3 gap-x-6 gap-y-4">
                    <HeroCard
                        filename="product-cloud-light.svg"
                    ...
                    />
                    <HeroCard
                        filename="product-clickstack-light.svg"
                        title="ClickStack"
                    ...
                    />
                    <HeroCard
                        filename="product-chdb-light.svg"
                        title="chDB"
...
<div className="relative">
    ...
    <div className="relative z-10 px-0 lg:px-4 py-16 lg:py-12 lg:pb-24 max-w-6xl mx-auto">
        ...
        <div className="text-center my-6">
            <a className="inline-block text-gray-900 dark:text-[#fdff75] hover:underline text-xs font-normal" href="/docs/get-started/quick-starts/create-your-first-service-on-cloud">Get started with ClickHouse Cloud →</a>
